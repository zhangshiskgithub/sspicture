...
/**
 * desc: 裁剪图片的imageview<br>
 * author by zsq <br>
 * create on 2018/10/31 16:05<br>
 */

public class CropImageView extends android.support.v7.widget.AppCompatImageView implements
    ...
    public CropImageView(Context context, AttributeSet attrs) {
                ...
                new GestureDetector.SimpleOnGestureListener() {
                    ...
                    public boolean onDoubleTap(MotionEvent e) {
                        ...
                        if (getScale() < mScaleMin) {
                            CropImageView.this.postDelayed(new AutoScaleRunnable(mScaleMin, x, y), 16);
                        } else {
                            CropImageView.this.postDelayed(new AutoScaleRunnable(mInitScale, x, y), 16);
                        }
                        isAutoScale = true;
        ...
        mAspectX = ta.getInteger(R.styleable.CropImageView_civWidth, 1);
        mAspectY = ta.getInteger(R.styleable.CropImageView_civHeight, 1);
        mClipPadding = ta.getDimensionPixelSize(R.styleable.CropImageView_civClipPadding, 0);
        mTipText = ta.getString(R.styleable.CropImageView_civTipText);
        mMaskColor = ta.getColor(R.styleable.CropImageView_civMaskColor, 0xB2000000);
        mDrawCircleFlag = ta.getBoolean(R.styleable.CropImageView_civClipCircle, false);
        mRoundCorner = ta.getDimension(R.styleable.CropImageView_civClipRoundCorner, 0);
        final int textSize = ta.getDimensionPixelSize(R.styleable.CropImageView_civTipTextSize, 24);
